...
#######################################################################################3
        ...
        self.RC_Statement.setGeometry(QtCore.QRect(520, 350, 200, 25))
        self.RC_Statement.setText("Created by Raymond Cheng 2020")
...
##
    ...
    def importData(self):
        ...
        try:
            ...
            return ctypes.windll.user32.MessageBoxW(0, "Not selected or bad format", "Import warning", 1)
        print(self.vdrv)
